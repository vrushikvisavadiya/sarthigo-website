...
import { useCreateOwner } from "@/services/owners.service";
...
export function CreateOwnerForm({ onSuccess }: CreateOwnerFormProps) {
  ...
  const onSubmit = (data: CreateOwnerFormData) => {
    createOwner(data, {
      onSuccess: () => {
